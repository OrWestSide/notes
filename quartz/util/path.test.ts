...
describe("link strategies", () => {
  ...
  describe("absolute", () => {
    ...
    test("from a/b/c", () => {
      ...
      assert.strictEqual(path.transformLink(cur, "main-page.png", opts), "../../main-page.png")
  ...
  describe("shortest", () => {
    ...
    test("from a/b/c", () => {
      ...
      assert.strictEqual(path.transformLink(cur, "a/b/index", opts), "../../a/b/")
      assert.strictEqual(path.transformLink(cur, "a/b/main-page.png", opts), "../../a/b/main-page.png")
